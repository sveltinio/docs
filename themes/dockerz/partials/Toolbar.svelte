<script lang="ts">
	import SearchBar from '../components/_SearchBar.svelte';
...
<nav
	class="mx-auto bg-skin-light border-b dark:bg-skin-pure-dark dark:border-skin-muted-dark border-skin-base"
>
